...
const RULES_8: GameRules = {
  ...
  //
  // 0.30（19 格，需净增 10）是用户选的新起点。**它同样未经跑分标定** ——
  // 现在它可以由「游戏」面板调整，等跑分出来再定最终值。
  lifeWinRatio: 0.3,
  deathWinRatio: 0.05,
  lifeStreak: 3,
  deathStreak: 3,
