...
> ✅ **状态：已完成，且仓库已发布。**
> M1 的全部任务都已落地；仓库于 **2026-09-21 发布 `1.0.0`**（公开仓库 + Vercel +
> GitHub Pages 都在跑，地址见 `README.md`）。
>
> **这份文件现在只作历史记录用** —— 它记的是**当时的取舍过程与实测原始数据**，
> 不代表当前状态，里面的代码块也可能是当初的草稿。
>
> | 想知道 | 读哪份 |
> |---|---|
> | 当前是什么样 | `README.md` |
> | 为什么这样设计 | `DESIGN.md` |
> | 改代码要知道的红线与命令 | `CLAUDE.md` |
